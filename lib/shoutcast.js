...
Station.prototype.onStart = function() {
...
Station.prototype.addSong = function(track) {
  var self = this;
  function add(f) {
...
Station.prototype.upNext = function () {return this.stream.getQueue();}; // TODO
Station.prototype.lastPlayed = function () {return this.stream.getQueue();}; // TODO
Station.prototype.skip = function() {this.stream.startNext();};
Station.prototype.listeners = function () {return this.stats.listeners;};
Station.prototype.song = function () {return this.stream.getCurrent();};
